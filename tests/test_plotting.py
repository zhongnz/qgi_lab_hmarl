    ...
    return pd.DataFrame(
        {
            ...
            "coordinator_top1_prob": [0.12, 0.13, 0.14, 0.16, 0.17, 0.19, 0.21, 0.24, 0.27, 0.3],
            "port_top1_prob": [0.35, 0.36, 0.38, 0.39, 0.4, 0.42, 0.43, 0.45, 0.47, 0.49],
            "coordinator_entropy_gap_from_uniform": [0.01, 0.02, 0.03, 0.05, 0.06, 0.08, 0.1, 0.13, 0.16, 0.2],
            "port_entropy_gap_from_uniform": [0.05, 0.06, 0.08, 0.09, 0.1, 0.12, 0.14, 0.16, 0.18, 0.2],
