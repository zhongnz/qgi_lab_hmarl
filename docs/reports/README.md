...
- experiment result writeups
- milestone reports
- presentation prep notes

## Naming

`YYYY-MM-DD_report-topic.md`
...
- `2026-03-13_report-presentation-materials.md`: audience-facing presentation deck outline, speaker notes, and backup slides for the Friday 2026-03-13 project presentation.
